    ...
    targets: [
        .target(
            ...
            resources: [
                ...
                .copy("Readability.js"),
                // Generated by tools/build-legibility.sh from the pinned legibility
                // commit. `.copy` and not `.process`: it is loaded with `loadFileURL`, so it
                // has to reach the bundle as the exact same file.
                .copy("Legibility.html"),
            ],
